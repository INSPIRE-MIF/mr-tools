...
-- 		AND (
-- 	 		(LOWER(m.data) LIKE '%<gmd:md_metadata%<gmd:identificationinfo%<gmd:md_dataidentification%<gmd:descriptivekeywords%<gmd:md_keywords%<gmd:keyword%http%inspire.ec.europa.eu%theme_ad%<gmd:thesaurusname%<gmd:ci_citation%<gmd:title%gemet%inspire%themes%')
...
-- 			OR (LOWER(m.data) LIKE '%<gmd:md_metadata%<gmd:identificationinfo%<gmd:md_dataidentification%<gmd:descriptivekeywords%<gmd:md_keywords%<gmd:keyword%http%inspire.ec.europa.eu%theme_au%<gmd:thesaurusname%<gmd:ci_citation%<gmd:title%gemet%inspire%themes%')
...
-- 	 		OR (LOWER(m.data) LIKE '%<gmd:md_metadata%<gmd:identificationinfo%<gmd:md_dataidentification%<gmd:descriptivekeywords%<gmd:md_keywords%<gmd:keyword%http%inspire.ec.europa.eu%theme_cp%<gmd:thesaurusname%<gmd:ci_citation%<gmd:title%gemet%inspire%themes%')
...
-- 	 		OR (LOWER(m.data) LIKE '%<gmd:md_metadata%<gmd:identificationinfo%<gmd:md_dataidentification%<gmd:descriptivekeywords%<gmd:md_keywords%<gmd:keyword%http%inspire.ec.europa.eu%theme_rs%<gmd:thesaurusname%<gmd:ci_citation%<gmd:title%gemet%inspire%themes%')
...
-- 	 		OR (LOWER(m.data) LIKE '%<gmd:md_metadata%<gmd:identificationinfo%<gmd:md_dataidentification%<gmd:descriptivekeywords%<gmd:md_keywords%<gmd:keyword%http%inspire.ec.europa.eu%theme_gg%<gmd:thesaurusname%<gmd:ci_citation%<gmd:title%gemet%inspire%themes%')
...
-- 	 		OR (LOWER(m.data) LIKE '%<gmd:md_metadata%<gmd:identificationinfo%<gmd:md_dataidentification%<gmd:descriptivekeywords%<gmd:md_keywords%<gmd:keyword%http%inspire.ec.europa.eu%theme_gn%<gmd:thesaurusname%<gmd:ci_citation%<gmd:title%gemet%inspire%themes%')
...
-- 	 		OR (LOWER(m.data) LIKE '%<gmd:md_metadata%<gmd:identificationinfo%<gmd:md_dataidentification%<gmd:descriptivekeywords%<gmd:md_keywords%<gmd:keyword%http%inspire.ec.europa.eu%theme_hy%<gmd:thesaurusname%<gmd:ci_citation%<gmd:title%gemet%inspire%themes%')
...
-- 	 		OR (LOWER(m.data) LIKE '%<gmd:md_metadata%<gmd:identificationinfo%<gmd:md_dataidentification%<gmd:descriptivekeywords%<gmd:md_keywords%<gmd:keyword%http%inspire.ec.europa.eu%theme_ps%<gmd:thesaurusname%<gmd:ci_citation%<gmd:title%gemet%inspire%themes%')
...
-- 	 		OR (LOWER(m.data) LIKE '%<gmd:md_metadata%<gmd:identificationinfo%<gmd:md_dataidentification%<gmd:descriptivekeywords%<gmd:md_keywords%<gmd:keyword%http%inspire.ec.europa.eu%theme_tn%<gmd:thesaurusname%<gmd:ci_citation%<gmd:title%gemet%inspire%themes%') 
...
-- ANNEX II	Filter	
-- 		AND (
-- 			(LOWER(m.data) LIKE '%<gmd:md_metadata%<gmd:identificationinfo%<gmd:md_dataidentification%<gmd:descriptivekeywords%<gmd:md_keywords%<gmd:keyword%http%inspire.ec.europa.eu%theme_el%<gmd:thesaurusname%<gmd:ci_citation%<gmd:title%gemet%inspire%themes%')
...
-- 			OR (LOWER(m.data) LIKE '%<gmd:md_metadata%<gmd:identificationinfo%<gmd:md_dataidentification%<gmd:descriptivekeywords%<gmd:md_keywords%<gmd:keyword%http%inspire.ec.europa.eu%theme_ge%<gmd:thesaurusname%<gmd:ci_citation%<gmd:title%gemet%inspire%themes%')
...
-- 			OR (LOWER(m.data) LIKE '%<gmd:md_metadata%<gmd:identificationinfo%<gmd:md_dataidentification%<gmd:descriptivekeywords%<gmd:md_keywords%<gmd:keyword%http%inspire.ec.europa.eu%theme_lc%<gmd:thesaurusname%<gmd:ci_citation%<gmd:title%gemet%inspire%themes%')
...
-- 			OR (LOWER(m.data) LIKE '%<gmd:md_metadata%<gmd:identificationinfo%<gmd:md_dataidentification%<gmd:descriptivekeywords%<gmd:md_keywords%<gmd:keyword%http%inspire.ec.europa.eu%theme_oi%<gmd:thesaurusname%<gmd:ci_citation%<gmd:title%gemet%inspire%themes%')
...
-- ANNEX III Filter		
-- 		AND (
-- 			(LOWER(m.data) LIKE '%<gmd:md_metadata%<gmd:identificationinfo%<gmd:md_dataidentification%<gmd:descriptivekeywords%<gmd:md_keywords%<gmd:keyword%http%inspire.ec.europa.eu%theme_af%<gmd:thesaurusname%<gmd:ci_citation%<gmd:title%gemet%inspire%themes%')
...
-- 			OR (LOWER(m.data) LIKE '%<gmd:md_metadata%<gmd:identificationinfo%<gmd:md_dataidentification%<gmd:descriptivekeywords%<gmd:md_keywords%<gmd:keyword%http%inspire.ec.europa.eu%theme_am%<gmd:thesaurusname%<gmd:ci_citation%<gmd:title%gemet%inspire%themes%')
...
-- 			OR (LOWER(m.data) LIKE '%<gmd:md_metadata%<gmd:identificationinfo%<gmd:md_dataidentification%<gmd:descriptivekeywords%<gmd:md_keywords%<gmd:keyword%http%inspire.ec.europa.eu%theme_ac%<gmd:thesaurusname%<gmd:ci_citation%<gmd:title%gemet%inspire%themes%')
...
-- 			OR (LOWER(m.data) LIKE '%<gmd:md_metadata%<gmd:identificationinfo%<gmd:md_dataidentification%<gmd:descriptivekeywords%<gmd:md_keywords%<gmd:keyword%http%inspire.ec.europa.eu%theme_br%<gmd:thesaurusname%<gmd:ci_citation%<gmd:title%gemet%inspire%themes%')
...
-- 			OR (LOWER(m.data) LIKE '%<gmd:md_metadata%<gmd:identificationinfo%<gmd:md_dataidentification%<gmd:descriptivekeywords%<gmd:md_keywords%<gmd:keyword%http%inspire.ec.europa.eu%theme_bu%<gmd:thesaurusname%<gmd:ci_citation%<gmd:title%gemet%inspire%themes%')
...
-- 			OR (LOWER(m.data) LIKE '%<gmd:md_metadata%<gmd:identificationinfo%<gmd:md_dataidentification%<gmd:descriptivekeywords%<gmd:md_keywords%<gmd:keyword%http%inspire.ec.europa.eu%theme_er%<gmd:thesaurusname%<gmd:ci_citation%<gmd:title%gemet%inspire%themes%')
...
-- 			OR (LOWER(m.data) LIKE '%<gmd:md_metadata%<gmd:identificationinfo%<gmd:md_dataidentification%<gmd:descriptivekeywords%<gmd:md_keywords%<gmd:keyword%http%inspire.ec.europa.eu%theme_ef%<gmd:thesaurusname%<gmd:ci_citation%<gmd:title%gemet%inspire%themes%')
...
-- 			OR (LOWER(m.data) LIKE '%<gmd:md_metadata%<gmd:identificationinfo%<gmd:md_dataidentification%<gmd:descriptivekeywords%<gmd:md_keywords%<gmd:keyword%http%inspire.ec.europa.eu%theme_hb%<gmd:thesaurusname%<gmd:ci_citation%<gmd:title%gemet%inspire%themes%')
...
-- 			OR (LOWER(m.data) LIKE '%<gmd:md_metadata%<gmd:identificationinfo%<gmd:md_dataidentification%<gmd:descriptivekeywords%<gmd:md_keywords%<gmd:keyword%http%inspire.ec.europa.eu%theme_hh%<gmd:thesaurusname%<gmd:ci_citation%<gmd:title%gemet%inspire%themes%') 
...
-- 			OR (LOWER(m.data) LIKE '%<gmd:md_metadata%<gmd:identificationinfo%<gmd:md_dataidentification%<gmd:descriptivekeywords%<gmd:md_keywords%<gmd:keyword%http%inspire.ec.europa.eu%theme_lu%<gmd:thesaurusname%<gmd:ci_citation%<gmd:title%gemet%inspire%themes%') 
...
-- 			OR (LOWER(m.data) LIKE '%<gmd:md_metadata%<gmd:identificationinfo%<gmd:md_dataidentification%<gmd:descriptivekeywords%<gmd:md_keywords%<gmd:keyword%http%inspire.ec.europa.eu%theme_mf%<gmd:thesaurusname%<gmd:ci_citation%<gmd:title%gemet%inspire%themes%') 
...
-- 			OR (LOWER(m.data) LIKE '%<gmd:md_metadata%<gmd:identificationinfo%<gmd:md_dataidentification%<gmd:descriptivekeywords%<gmd:md_keywords%<gmd:keyword%http%inspire.ec.europa.eu%theme_mr%<gmd:thesaurusname%<gmd:ci_citation%<gmd:title%gemet%inspire%themes%') 
...
-- 			OR (LOWER(m.data) LIKE '%<gmd:md_metadata%<gmd:identificationinfo%<gmd:md_dataidentification%<gmd:descriptivekeywords%<gmd:md_keywords%<gmd:keyword%http%inspire.ec.europa.eu%theme_nz%<gmd:thesaurusname%<gmd:ci_citation%<gmd:title%gemet%inspire%themes%') 
...
-- 			OR (LOWER(m.data) LIKE '%<gmd:md_metadata%<gmd:identificationinfo%<gmd:md_dataidentification%<gmd:descriptivekeywords%<gmd:md_keywords%<gmd:keyword%http%inspire.ec.europa.eu%theme_of%<gmd:thesaurusname%<gmd:ci_citation%<gmd:title%gemet%inspire%themes%') 
...
-- 			OR (LOWER(m.data) LIKE '%<gmd:md_metadata%<gmd:identificationinfo%<gmd:md_dataidentification%<gmd:descriptivekeywords%<gmd:md_keywords%<gmd:keyword%http%inspire.ec.europa.eu%theme_pd%<gmd:thesaurusname%<gmd:ci_citation%<gmd:title%gemet%inspire%themes%') 
...
-- 			OR (LOWER(m.data) LIKE '%<gmd:md_metadata%<gmd:identificationinfo%<gmd:md_dataidentification%<gmd:descriptivekeywords%<gmd:md_keywords%<gmd:keyword%http%inspire.ec.europa.eu%theme_pf%<gmd:thesaurusname%<gmd:ci_citation%<gmd:title%gemet%inspire%themes%') 
...
-- 			OR (LOWER(m.data) LIKE '%<gmd:md_metadata%<gmd:identificationinfo%<gmd:md_dataidentification%<gmd:descriptivekeywords%<gmd:md_keywords%<gmd:keyword%http%inspire.ec.europa.eu%theme_sr%<gmd:thesaurusname%<gmd:ci_citation%<gmd:title%gemet%inspire%themes%') 
...
-- 			OR (LOWER(m.data) LIKE '%<gmd:md_metadata%<gmd:identificationinfo%<gmd:md_dataidentification%<gmd:descriptivekeywords%<gmd:md_keywords%<gmd:keyword%http%inspire.ec.europa.eu%theme_so%<gmd:thesaurusname%<gmd:ci_citation%<gmd:title%gemet%inspire%themes%') 
...
-- 			OR (LOWER(m.data) LIKE '%<gmd:md_metadata%<gmd:identificationinfo%<gmd:md_dataidentification%<gmd:descriptivekeywords%<gmd:md_keywords%<gmd:keyword%http%inspire.ec.europa.eu%theme_sd%<gmd:thesaurusname%<gmd:ci_citation%<gmd:title%gemet%inspire%themes%') 
...
-- 			OR (LOWER(m.data) LIKE '%<gmd:md_metadata%<gmd:identificationinfo%<gmd:md_dataidentification%<gmd:descriptivekeywords%<gmd:md_keywords%<gmd:keyword%http%inspire.ec.europa.eu%theme_su%<gmd:thesaurusname%<gmd:ci_citation%<gmd:title%gemet%inspire%themes%') 
...
-- 			OR (LOWER(m.data) LIKE '%<gmd:md_metadata%<gmd:identificationinfo%<gmd:md_dataidentification%<gmd:descriptivekeywords%<gmd:md_keywords%<gmd:keyword%http%inspire.ec.europa.eu%theme_us%<gmd:thesaurusname%<gmd:ci_citation%<gmd:title%gemet%inspire%themes%') 
