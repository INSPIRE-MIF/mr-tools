...
input_directory = 'download'
summary_stats_file = 'download/summary_statistics.csv'
...
for input_file in os.listdir(input_directory):
    if input_file.endswith(".csv"):
        ...
        output_csv = 'download/' + input_file.rstrip('.csv') + '_url_check_results.csv'
        failed_log = 'download/' + input_file.rstrip('.csv') + '_failed_requests.log'
