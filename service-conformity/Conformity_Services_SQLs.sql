-- M&R 2023 EVALUATION OF SERVICES CONFORMITY VIA SQL
...
-- DISCOVERY Service Filter -- FOR LV ONLY: substitute %<gmd:identificationinfo per %<identificationinfo 
-- 		AND (
...
-- VIEW Service Filter -- FOR LV ONLY: substitute %<gmd:identificationinfo per %<%identificationinfo
-- 		AND (
...
-- DOWNLOAD Service Filter -- FOR LV ONLY: substitute %<gmd:identificationinfo per %<identificationinfo
-- 		AND (
...
-- TRANSFORMATION Service Filter -- FOR LV ONLY: substitute %<gmd:identificationinfo per %<identificationinfo
-- 		AND (
